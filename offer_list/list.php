...
while($query2=mysql_fetch_array($query1))
{
	...
	echo "<td><a  href='edit.php?offer_no=".$query2['offer_no']."'><button  class='btn btn-primary' style='height:30px;' style='width:90px;' style='color:red;'>UPDATE</button></a></td>";
	echo "<td ><a href='delete.php?offer_no=".$query2['offer_no']."'><button  class='btn btn-danger' style='height:30px;' style='width:90px;'> REMOVE</button></a></td></tr>";
